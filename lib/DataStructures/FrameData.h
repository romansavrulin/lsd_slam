...
template <int __LEVELS> struct FrameData {
  ...
  // data from initial tracking, indicating which pixels in the reference frame
  // ware good or not. deleted as soon as frame is used for mapping.
