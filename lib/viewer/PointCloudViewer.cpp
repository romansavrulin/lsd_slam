...
void PointCloudViewer::reset()
{
	...
	save_folder = ros::package::getPath("lsd_slam_core")+"/save/";
...
void PointCloudViewer::addFrameMsg(lsd_slam_core::keyframeMsgConstPtr msg)
{
	meddleMutex.lock();
...
void PointCloudViewer::addGraphMsg(lsd_slam_core::keyframeGraphMsgConstPtr msg)
{
	meddleMutex.lock();
